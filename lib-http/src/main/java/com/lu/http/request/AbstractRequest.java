package com.lu.http.request;

import com.lu.http.Interface.IExecute;
import com.lu.http.Interface.IRequest;
import com.lu.http.OkClient;
import com.lu.http.annotation.LMethod;
import com.lu.http.obj.HttpException;
...
public abstract class AbstractRequest<T extends AbstractRequest> implements IRequest<T>, IExecute {
    ...
    private String mUrl;
    private Enum<LMethod> mMethod = LMethod.POST;
    private Object mTag;
    ...
    @Override
    public T method(Enum<LMethod> method) {
        this.mMethod = method;
        return thisInstance;
    }
